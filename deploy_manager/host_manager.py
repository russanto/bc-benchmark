        ...
        def get_hosts_connections(hosts):
                ...
                for host in hosts:
                        hosts_connections[host] = {
                                ...
                                "ssh": Connection(host=host, user=HostManager.host_conf["ssh_username"], connect_kwargs={"key_filename": ["/Users/antonio/.docker/machine/machines/node1/id_rsa","/Users/antonio/.docker/machine/machines/node2/id_rsa", "/Users/antonio/.docker/machine/machines/node3/id_rsa"]})
                        }
